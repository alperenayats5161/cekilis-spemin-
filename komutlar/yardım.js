...
exports.run = async (client, message, args) => { 
  ...
  .addField("<a:sag:800633039263891466> **• | s.logo**",`Botun istatistiklerini gösterir`)
  
  .addField("<a:sag:800633039263891466> **• | s.eglence**",`Eglence Komutlarını Gösterir`)
  
  .addField("<a:sag:800633039263891466> **• | s.moderasyon**",`Moderasyon Komutlarını Gösterir`)
  
  .addField("<a:sag:800633039263891466> **• | s.yardım1**",`Yardım1 Komutlarını Gösterir`)
